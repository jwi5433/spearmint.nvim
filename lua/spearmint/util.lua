...
function M.invert(color)
  ...
  elseif type(color) == "string" then
    local hsluv = require("spearmint.hsluv")
    if color ~= "NONE" then
...
---@param groups spearmint.Highlights
...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/spearmint-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, spearmint.Cache
