...
function M.setup(opts)
  ...
  local colors = require("spearmint.colors").setup(opts)
  local groups = require("spearmint.groups").setup(colors, opts)

  groups.NeoTreeFileName = { fg = "#78dce8" }
  groups.NeoTreeDirectoryName = { fg = "#10DA9F" }
  ...
  vim.g.colors_name = "spearmint-" .. opts.style
